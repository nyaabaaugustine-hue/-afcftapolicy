...
const BlogSection = ({ onNavigate }: BlogSectionProps) => {
  const blogPosts = [
    {
    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
          <div>
            <span className="text-amber-500 text-sm font-medium uppercase tracking-wider">Events and Blog</span>
            <h2 className="text-gray-900 text-3xl md:text-4xl font-bold mt-2">Learn more from our upcoming events and blog.</h2>
          </div>
          <p className="text-gray-600 max-w-md">
            Our Blog to help you and the media better-understand the AfCFTA agreement and its benefits to the country.
          </p>
        </div>
